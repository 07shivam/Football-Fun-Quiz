   ...
   <body>
      ...
      <div class="container "><br>
         <div class="container">
            ...
            <!-- <h1 class="text-center text-success text-uppercase animateuse" >  Football Fun Quiz </h1>
            <br> -->
            <div class=" col-lg-12 text-center">
               <h3> <a href="#" class="text-uppercase text-warning"> <?php echo $_SESSION['username']; ?>,</a> Welcome to Football Fun Quiz </h3>
            </div>
            <br>
            <div class="col-lg-8 d-block m-auto bg-light quizsetting ">
               ...
               <form action="checked.php" method="post">
                  ...
                  <div class="card">
                     ...
                     <?php
                        $sql = "SELECT * FROM `answers` WHERE `qid` = $i limit $page1, 1";
                     ...
                     <div class="card-block">
                        <input type="radio" name="quizcheck[<?php echo $ans_id; ?>]" id="<?php echo $ans_id; ?>" value="<?php echo $row['aid']; ?>" > <?php echo $row['ans']; ?> 
                        <br>
                     </div>
                     <?php
         ...
         <br>
         <footer>
            <h5 class="text-center"> By Shivam Bhargava </h5> 
         </footer>
      </div>
