     ...
     <div class="container text-center" >
      ...
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
        	...
        	<td>
            <?php
            echo "Out of 5 Questions, You have attempted ".$checked_count." option."; ?>
            </td>
            ...
            $finalresult = " insert into usersession(username,totalques, answerscorrect) values ('$name','5','$Resultans') ";
